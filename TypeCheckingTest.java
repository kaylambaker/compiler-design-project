...
public class TypeCheckingTest {
  ...
  public static void main(String[] args) {
    ...
    if (program != null) {
      try {
        Type typeCatch = program.typeCheck();
        System.err.println("\u001B[32mAll good!\u001B[0m");
        System.out.println("All good!");
      } catch (TypeCheckException egg) {
        String s = "class<" + program.id + ">: ";
        if (egg.methoddecltype != null)
          s += egg.methoddecltype + " " + egg.methoddeclstr + ": ";
